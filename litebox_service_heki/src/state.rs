...
//! Memory-touching helpers take a `&impl VsmBackend` and use its VTL0
...
use litebox_common_lvbs::{
    HekiKernelSymbol, HekiPatch, HekiPatchInfo, HekiRange, ModMemType, VsmBackend, VsmError,
};
use thiserror::Error;
use x86_64::{
    PhysAddr, VirtAddr,
...
impl ModuleMemory {
    ...
    #[inline]
    pub(crate) fn write_bytes_from_heki_range<P: VsmBackend>(
        &mut self,
        vsm: &Vsm<P>,
...
impl MemoryContainer {
    ...
    pub(crate) fn write_vtl0_phys_bytes<P: VsmBackend>(
        &mut self,
        vsm: &Vsm<P>,
        phys_start: PhysAddr,
        phys_end: PhysAddr,
