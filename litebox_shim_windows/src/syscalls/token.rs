...
impl<Platform: ShimPlatform, FS: ShimFS> Task<Platform, FS> {
    ...
    pub(crate) fn sys_nt_query_information_token(
        ...
        let status = match token_information_class {
            ...
            | TokenInformationClass::VirtualizationEnabled => token.write_u32::<Platform>(
                token_information,
                token_information_length,
                return_length,
                0,
            ...
            TokenInformationClass::HasRestrictions => token.write_u8::<Platform>(
                token_information,
                token_information_length,
                return_length,
                0,
    ...
    pub(crate) fn sys_nt_query_security_attributes_token(
        ...
        if let Err(status) = self.token_handle(token_handle).map(drop) {
            return status;
        }
...
impl TokenHandleObject {
    ...
    fn write_u8<Platform: ShimPlatform>(
        self,
        token_information: MutPtr<Platform, u8>,
        token_information_length: u32,
        return_length: MutPtr<Platform, u32>,
    ...
    fn write_source<Platform: ShimPlatform>(
        ...
        self.write_value::<Platform, [u8; 16]>(
            token_information,
            token_information_length,
            return_length,
            &source,
