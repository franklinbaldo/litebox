...
#[allow(dead_code)] // Used by spawn_worker_host_for_exec / wait_worker_host (Step 19).
...
pub struct LinuxUserland {
    ...
    #[allow(dead_code)] // Used by spawn_worker_host_for_exec (Step 19).
    ...
    #[allow(dead_code)] // Used by reap_finished_worker_bridge_threads (Step 19).
...
unsafe fn interrupt_signal_handler(
    ...
    #[cfg(target_arch = "x86_64")]
    let at_syscall_callback = ip == syscall_callback as *const () as usize
        || ip == syscall_callback_redzone as *const () as usize;
    #[cfg(target_arch = "x86")]
    let at_syscall_callback = ip == syscall_callback as *const () as usize;
    if at_syscall_callback {
