...
const SKIP_FILES: &[&str] = &[
    ...
    "litebox_runner_macos_userland/tests/test-bins/efault_static",
    "litebox_runner_macos_userland/tests/test-bins/execve_static",
    "litebox_runner_macos_userland/tests/test-bins/hello_exec_nolibc",
    "litebox_runner_macos_userland/tests/test-bins/hello_thread",
    "litebox_runner_macos_userland/tests/test-bins/hello_thread_static",
    "litebox_runner_macos_userland/tests/test-bins/hello_world_dyn",
    "litebox_runner_macos_userland/tests/test-bins/hello_world_static",
    "litebox_runner_macos_userland/tests/test-bins/ld-linux-aarch64.so.1",
    "litebox_runner_macos_userland/tests/test-bins/libc.so.6",
    "litebox_runner_macos_userland/tests/test-bins/litebox_rtld_audit.so",
    "litebox_runner_macos_userland/tests/test-bins/signal_static",
    "litebox_runner_macos_userland/tests/test-bins/thread_static",
    "litebox_runner_macos_userland/tests/test-bins/unix_static",
