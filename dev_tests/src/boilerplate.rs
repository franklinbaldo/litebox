...
const SKIP_FILES: &[&str] = &[
    ...
    "litebox_runner_linux_on_windows_userland/tests/test-bins/fork_exec_wait",
    "litebox_runner_linux_on_windows_userland/tests/test-bins/pipe_cloexec",
    "litebox_runner_linux_on_windows_userland/tests/test-bins/pipe_cross_process",
