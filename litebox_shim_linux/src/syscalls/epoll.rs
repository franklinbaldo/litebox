...
impl<FS: ShimFS> EpollFile<FS> {
    ...
    #[allow(dead_code)] // called by close() logic added in a later PR
...
mod test {
    ...
    // NOTE: test_sys_epoll_pwait_with_eventfd_and_timerfd is deferred to the PR
    // that introduces sys_timerfd_create.
