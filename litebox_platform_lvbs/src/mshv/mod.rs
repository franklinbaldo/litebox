...
pub use litebox_common_lvbs::{
    ...
    NUM_VTLCALL_PARAMS, VSM_VTL_CALL_FUNC_ID_ALLOCATE_RINGBUFFER_MEMORY,
    ...
    VSM_VTL_CALL_FUNC_ID_LOCK_REGS, VSM_VTL_CALL_FUNC_ID_OPTEE_MESSAGE,
    VSM_VTL_CALL_FUNC_ID_PATCH_TEXT, VSM_VTL_CALL_FUNC_ID_PROTECT_MEMORY,
    VSM_VTL_CALL_FUNC_ID_SET_PLATFORM_ROOT_KEY, VSM_VTL_CALL_FUNC_ID_SIGNAL_END_OF_BOOT,
    VSM_VTL_CALL_FUNC_ID_UNLOAD_MODULE, VSM_VTL_CALL_FUNC_ID_VALIDATE_MODULE, VsmError, VsmFunction,
};
