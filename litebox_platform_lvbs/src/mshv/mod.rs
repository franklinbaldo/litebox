...
/// Adapter granting authority to map and modify protected VTL0 frames.
///
...
impl<'a, P> PrivilegedVmap<'a, P> {
    ...
    /// so `PrivilegedVmap::mint` is the grep target for auditing them. Named to match the
    /// [`LvbsVtl0Gate`](crate::mshv::vsm::LvbsVtl0Gate) family of capabilities.
